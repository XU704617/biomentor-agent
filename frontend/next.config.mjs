...
const nextConfig = {
  ...
  async rewrites() {
    return [
      ...
      { source: "/api/evidence/:path*", destination: `${backendBaseUrl}/api/evidence/:path*` },
      { source: "/api/knowledge-graph/:path*", destination: `${backendBaseUrl}/api/knowledge-graph/:path*` },
      { source: "/api/literature/:path*", destination: `${backendBaseUrl}/api/literature/:path*` },
      { source: "/api/materials/:path*", destination: `${backendBaseUrl}/api/materials/:path*` },
      { source: "/api/paper-library/:path*", destination: `${backendBaseUrl}/api/paper-library/:path*` },
      ...
      { source: "/api/research/:path*", destination: `${backendBaseUrl}/api/research/:path*` },

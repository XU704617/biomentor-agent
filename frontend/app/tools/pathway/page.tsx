    ...
    <div className="min-h-screen pt-[var(--nav-height)] flex flex-col px-6 md:px-10 pb-10 font-body">
      <div className="flex flex-col lg:flex-row flex-1 gap-6" style={{ minHeight: 0 }}>
        <div className="flex-[3] flex flex-col gap-4 min-w-0">
          <div className="flex items-center gap-3">
            ...
            <div className="relative flex-1 max-w-xs">
              ...
              <input
                ...
                placeholder="搜索通路..."
                className="w-full pl-9 pr-4 py-2.5 rounded-xl text-xs bg-white/60 backdrop-blur border border-white/80 text-brand-ink placeholder:text-brand-faint outline-none focus:border-accent-electric/30 focus:ring-2 focus:ring-accent-electric/10 transition-all"
              />
            </div>
          </div>

          <div
            className="glass-card flex-1 flex items-center justify-center min-h-0 overflow-hidden"
          ...
          <div className="flex items-center gap-4 text-[11px] text-brand-muted px-1">
